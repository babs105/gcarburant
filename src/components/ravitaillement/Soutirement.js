...
import { RavitaillementContext } from "../../context/RavitaillementContext";
import { CuveContext } from "../../context/CuveContext";
import { UserContext } from "../../context/UserContext";
import moment from "moment";

function Soutirement({ history }) {
  const { soutirer } = useContext(RavitaillementContext);
                    ...
                    <div className="col-12 col-sm-6">
                      <div className="form-group">
                        ...
                        <input
                          ...
                          placeholder="Volume soutiré  en ( litres )"
                        />
                        <div className="invalid-feedback">
