  ...
  return (
    <>
      <div className="card p-5 ">
        <div className=" d-sm-flex justify-content-start align-items-center mb-4 text-center">
          <img
            className="img-fluid w-25 mr-3 "
            src={"/images/user-profile.svg"}
            alt=""
          />
          <h2 className="mr-2 "> {user.firstName} </h2>
          <h2> {user.lastName}</h2>
        </div>
        <div className="row">
          <h6 className="col-12 lead "> E-mail: {user.username}</h6>
          <h6 className="col-12  lead"> Role : {user.role}</h6>
        </div>
